...
def list():
    ...
    m = db.session.query(Img).order_by(desc(Img.UpdateTime)).all()
...
def create():
    ...
    return render_template('admin/image/create.html', platform=platform, os=os, library=library, application=application)
